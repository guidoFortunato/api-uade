  ...
  return (
    <>
            ...
            <div className="mb-4">
              {actor.birthday && (
                <div>
                  ...
                  <p>{`${actor.birthday.split("-")[2]} de ${getNameMonth(
                    actor.birthday.split("-")[1]
                  )} de ${actor.birthday.split("-")[0]}`}</p>
                </div>
              )}
            </div>
            <div className="mb-4">
      ...
      <div className="container px-10 py-10 mx-auto">
        <h2 className="text-base md:text-lg font-semibold text-white mb-5">
          Participaciones de {actor.name}
        </h2>
